...
class IndexSinceContractTests(unittest.TestCase):
    ...
    def test_index_since_filters_against_catalog(self):
        ...
        # health-velocity-trend, r187 skillbook-staleness). The
        # count is stable because the catalog is static; it moves
        # only when a new round lands, and the move is a deliberate
        # pin update, the way the r167 catalog count moved when
        # r169 landed.
