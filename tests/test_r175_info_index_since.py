...
class IndexSinceContractTests(unittest.TestCase):
    ...
    def test_index_since_filters_against_catalog(self):
        ...
        # seam-dry-run-machine-marker, r205
        ...
        # plain-english-directives, r248
        # frame-forgery, r249
        # history-metacog-untrusted, r250
        ...
        # rowid-detail-oneline, r263
        # audit-finding-oneline, r264,
        # alias-catalog-oneline, r265
        # meta-telemetry-untrusted, r266
        # trend-untrusted, r267
        # risk-untrusted, r268
        # message-untrusted, r269, gate-untrusted, r270,
        # skillbook-oneline, r271, history-tail-zero, r272,
        ...
        # history-empty-filter-before-truncation, r278). The
        # count is stable
        ...
        # r169 landed.
        self.assertEqual(len(recent), 99)
        for line in recent:
